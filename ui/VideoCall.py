...
from speak import RecordAndPlay
...
#         call facetracker
    ...
    def startVideo(self, cameraIndex, cameraIndex2):
        ...
        videoframe = tk.LabelFrame(self.topWindow,text='Captured video')
        videoframe.grid(column=0,row=0,columnspan=1,rowspan=1,padx=5, pady=5, ipadx=5, ipady=5)
        self.canvas = tk.Canvas(videoframe, width=480,height=640)
...
#         image = Image.open(path)
        ...
        smileButton = tk.Button(videoframe,text = "Smile")
        smileButton.grid(row=1, column=1)
        sadButton = tk.Button(videoframe,text = "Frown")
        sadButton.grid(row=4, column=1)
        surpriseButton = tk.Button(videoframe,text = "Surprise")
        surpriseButton.grid(row=2, column=1)
        neutralButton = tk.Button(videoframe,text = "Neutral")
